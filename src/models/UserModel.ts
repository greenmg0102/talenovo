...
export class UserModel {
    ...
    async createUser(clerkId: string, email: string, status: string, planName: string): Promise<User> {
        try {
            const result = await this.db.collection("users").insertOne({ clerkId, email, status, planName });
