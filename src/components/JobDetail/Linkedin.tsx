        ...
        <div className="flex justify-between items-start flex-wrap">
            ...
            <div className="w-full lg:w-1/4 pl-2">
                ...
                <div className=" border border-gray-200 rounded-[8px] shadow-2xl p-4 mb-4">
                    ...
                    <p className="text-gray-700 font-bold text-center"><span className="font-medium text-[14px]">{detail.companyName}</span></p>

                    <div className="py-4">
                        <p className="flex justify-center items-center text-gray-600 text-[12px] text-center">
                        ...
                        <p className="text-gray-500 text-[12px] pt-4 text-center">{detail.insightsV2[0]}</p>
                    </div>
                    <div className="flex justify-center items-center">
