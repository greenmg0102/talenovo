...
const SuggestedJobCard = ({ item }: any) => {
  ...
  return (
    <div className="p-2 border border-blue-200 hover:border-blue-500 cursor-pointer rounded-md mb-4">
      ...
      <p className="text-[14px] font-bold text-gray-500 mt-2">{item.title}</p>
