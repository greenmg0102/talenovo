    ...
    <div className="p-2">
      ...
      <div className="relative flex justify-start items-center mb-2">
        ...
        <div className="pl-4 pr-4">
          <Link href={`/job-detail/${item._id}`}>
            <p className="text-[16x] font-bold text-gray-500 hover:underline">{item.title}</p>
          </Link>
        ...
        <div className="absolute top-[2px] right-[2px]">
          <div className="flex justify-end" onClick={() => bookmark(item._id)}>
